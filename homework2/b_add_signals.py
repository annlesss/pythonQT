...
class Window(QtWidgets.QWidget):
    ...
    def initSignals(self) -> None:
        ...
        self.dateTimeEdit.dateTimeChanged.connect(lambda x: self.plainTextEditLog)  # TODO подключить слот для вывода датывремени в plainTextEditLog при изменении датывремени в dateTimeEdit
    ...
    def comboBoxIndexChanged(self):
        self.plainTextEditLog.setPlainText(f"{self.comboBox.currentIndex()}")
